...
assert(evidenceTruth.eligible_window_count > 0, "Quantum Edge hides available eligible point-in-time windows");
assert(evidenceTruth.provider_row_count >= evidenceTruth.eligible_window_count, "Quantum Edge provider-history row count is inconsistent with eligible windows");
assert(evidenceTruth.completed_partition_count > 0, "Quantum Edge hides completed provider partitions");
