...
assert(Number.isInteger(evidenceTruth.eligible_window_count) && evidenceTruth.eligible_window_count > 0, "Quantum Edge omits eligible untouched evidence");
assert(Number.isInteger(evidenceTruth.provider_row_count) && evidenceTruth.provider_row_count >= evidenceTruth.eligible_window_count, "Quantum Edge provider-history row count is inconsistent");
assert(Number.isInteger(evidenceTruth.completed_partition_count) && evidenceTruth.completed_partition_count > 0, "Quantum Edge omits completed provider partitions");
