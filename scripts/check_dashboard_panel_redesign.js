...
assertText(html, "/auth.css?v=20260526-d11k-view-model-refactor", "stylesheet cache key");
assertText(html, "/dashboard.js?v=20260526-d11k-view-model-refactor", "dashboard script cache key");
