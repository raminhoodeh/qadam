...
assertText(html, "/auth.css?v=20260607-cc10-remove-view-card", "stylesheet cache key");
assertText(html, "/dashboard.js?v=20260607-cc10-remove-view-card", "dashboard script cache key");
