...
assertText(html, "/auth.css?v=20260521-mission-control", "stylesheet cache key");
assertText(html, "/dashboard.js?v=20260521-mission-control", "dashboard script cache key");
