...
assertText(html, "/auth.css?v=20260607-cc5-contract-renderer", "stylesheet cache key");
assertText(html, "/dashboard.js?v=20260607-cc5-contract-renderer", "dashboard script cache key");
