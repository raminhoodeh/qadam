...
assertText(html, "/auth.css?v=20260526-language-cleanup", "stylesheet cache key");
assertText(html, "/dashboard.js?v=20260526-language-cleanup", "dashboard script cache key");
