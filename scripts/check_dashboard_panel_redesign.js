...
assertText(html, "/auth.css?v=20260526-d11b-nav-contract", "stylesheet cache key");
assertText(html, "/dashboard.js?v=20260526-d11b-nav-contract", "dashboard script cache key");
