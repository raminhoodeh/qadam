...
assertText(html, "/auth.css?v=20260526-paper-equity-chart", "stylesheet cache key");
assertText(html, "/dashboard.js?v=20260526-paper-equity-chart", "dashboard script cache key");
