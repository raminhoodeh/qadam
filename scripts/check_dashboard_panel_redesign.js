...
assertText(html, "/auth.css?v=20260526-advanced-debug-overview", "stylesheet cache key");
assertText(html, "/dashboard.js?v=20260526-advanced-debug-overview", "dashboard script cache key");
