...
assertText(html, "/auth.css?v=20260607-cc6-portfolio-timeline", "stylesheet cache key");
assertText(html, "/dashboard.js?v=20260607-cc6-portfolio-timeline", "dashboard script cache key");
