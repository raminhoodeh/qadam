...
assertText(html, "/auth.css?v=20260526-overview-operating-map", "stylesheet cache key");
assertText(html, "/dashboard.js?v=20260526-overview-operating-map", "dashboard script cache key");
