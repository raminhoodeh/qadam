...
assertText(html, "/auth.css?v=20260527-mission-control-ux", "stylesheet cache key");
assertText(html, "/dashboard.js?v=20260527-mission-control-ux", "dashboard script cache key");
