...
assertText(html, "/auth.css?v=20260607-cc8-prune-docs", "stylesheet cache key");
assertText(html, "/dashboard.js?v=20260607-cc8-prune-docs", "dashboard script cache key");
