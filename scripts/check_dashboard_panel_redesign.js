...
assertText(html, "/auth.css?v=20260527-health-language", "stylesheet cache key");
assertText(html, "/dashboard.js?v=20260527-health-language", "dashboard script cache key");
