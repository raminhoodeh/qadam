...
assertText(html, "/auth.css?v=20260607-cc7-visual-a11y", "stylesheet cache key");
assertText(html, "/dashboard.js?v=20260607-cc7-visual-a11y", "dashboard script cache key");
