...
assertText(html, "/auth.css?v=20260528-opportunity-scan", "stylesheet cache key");
assertText(html, "/dashboard.js?v=20260528-opportunity-scan", "dashboard script cache key");
