...
assertText(html, "/auth.css?v=20260526-d11j-tooltip-simplification", "stylesheet cache key");
assertText(html, "/dashboard.js?v=20260526-d11j-tooltip-simplification", "dashboard script cache key");
