...
assertText(html, "/auth.css?v=20260607-cc9-copy-runthrough", "stylesheet cache key");
assertText(html, "/dashboard.js?v=20260607-cc9-copy-runthrough", "dashboard script cache key");
