...
assert(guideHtml.includes("The current conclusion comes from the canonical Quantum Edge projection rather than this guide"), "User Guide canonical projection contract missing");
