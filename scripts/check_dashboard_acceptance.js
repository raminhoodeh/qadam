...
(async () => {
    ...
    [
        ...
        ["[data-overview-trading-strategies]", "Open the full universe"],
        ["[data-overview-trading-strategies]", "Asymmetric Catalyst Proxy Trading"],
        ["[data-overview-trading-strategies]", "Qadam-native edge"],
        ["[data-overview-trading-strategies]", "Semiconductor Policy Options Asymmetry"],
        ["[data-overview-trading-strategies]", "Defence Repricing Geopolitical Watch"],
        ["[data-overview-trading-strategies]", "Silver Macro Liquidity Stress"],
        ["[data-overview-trading-strategies]", "Crude Oil Energy Security Disruption"],
        ["[data-overview-trading-strategies]", "Prediction Market Geopolitical Dislocation"],
        ["[data-overview-trading-strategies]", "Akber filter"],
        ["[data-overview-trading-strategies]", "guarded Alpaca Paper"],
