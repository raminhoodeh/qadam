...
(async () => {
    ...
    [
        ...
        ["[data-overview-status-rail]", "Paper/demo only"],
        ["[data-overview-status-rail]", "Live capital disabled"],
        ["[data-overview-status-rail]", "Day 0/30"],
        ["[data-overview-hero]", "What should I know first?"],
        ...
        ["[data-overview-boundary-rail]", "Broker writes blocked"],
