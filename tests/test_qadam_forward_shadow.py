...
def test_provider_availability_uses_response_time(monkeypatch):
    import json
    from io import BytesIO
    from orchestrator import qadam_forward_shadow as shadow

    monkeypatch.setattr(shadow, "secret_value", lambda *args: "fixture-no-network")
...
def test_open_experiment_remains_observed_without_current_trigger(tmp_path, monkeypatch):
