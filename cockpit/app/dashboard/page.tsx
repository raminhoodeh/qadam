...
export default async function DashboardPage() {
  ...
  const registryCards = [
    ...
    },
    {
      ...
      } ${health.shadow_intelligence.provider_status.local_llm.mode.replaceAll("_", " ")} · probes ${
        health.shadow_intelligence.provider_status.local_llm.probe_status ?? "not called"
      }`
    },
    {
