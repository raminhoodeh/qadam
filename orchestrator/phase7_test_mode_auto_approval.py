...
def _base_decision_record(
    ...
    *,
    ...
    return {
        ...
        "source_origin_record_id": setup.get("source_origin_record_id"),
        "paperops_source_setup_record_id": setup.get("paperops_source_setup_record_id"),
        "source_signal_id": setup.get("source_signal_id"),
        "source_signal_review_id": setup.get("source_signal_review_id"),
        "source_signal_reviewed_at": setup.get("source_signal_reviewed_at"),
        "source_signal_status": setup.get("source_signal_status"),
        "signal_evidence_lineage_key": setup.get("signal_evidence_lineage_key"),
        "setup_freshness_key": setup.get("setup_freshness_key"),
        "research_goal_id": setup.get("research_goal_id"),
        "research_goal_lineage": deepcopy(setup.get("research_goal_lineage") or {}),
        "candidate_identity": setup.get("candidate_identity"),
