...
SERVICE_DEFINITIONS = (
    ...
    ServiceDefinition(
        service_id="strategy_research",
        purpose=(
            "Refresh exact read-only decision context and form V3 strategy drafts. "
            "The canonical compiler feeds Qadam's autonomous strategy decision."
        ),
        cadence_seconds=300,
        trigger="new_score_and_context",
        ownership="strategy_research",
        safe_retry_class="deterministic_calculation",
        recovery_mode="safe_revalidate",
        command_sequence=(
    ...
    ServiceDefinition(
        ...
        command_sequence=(
            ...
            ("scripts/check_qadam_strategy_decision.py",),
        ...
        generation_artifacts=(
            ...
            "qadam_strategy_decision_summary.json",
    ...
    ServiceDefinition(
        ...
        freshness_deadline_seconds=15 * 60,
        prerequisite_artifacts=("qadam_strategy_decision_checks.json",),
