...
def _auto_approval_record(
    ...
    *,
    ...
    return {
        ...
        "alpaca_symbol": candidate.get("alpaca_symbol"),
        ...
        "trading_lane": candidate.get("trading_lane"),
        "invalidation": deepcopy(candidate.get("invalidation")),
        "horizon": candidate.get("horizon"),
        "exit_policy": deepcopy(candidate.get("exit_policy") or {}),
...
def _order_material(record: dict[str, Any]) -> dict[str, Any]:
    return {
        ...
        "alpaca_symbol": str(record.get("alpaca_symbol") or "").upper(),
...
def _pre_trade_snapshot(record: dict[str, Any], material: dict[str, Any]) -> dict[str, Any]:
    return {
        ...
        "alpaca_symbol": material["alpaca_symbol"],
...
def _staged_order_record(record: dict[str, Any]) -> dict[str, Any]:
    ...
    checks = [
        ...
        {"name": "alpaca_symbol_present", "passed": bool(material["alpaca_symbol"])},
