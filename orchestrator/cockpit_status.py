...
from orchestrator.promotion_gates import (
...
QSASE_DASHBOARD_PUBLIC_ARTIFACTS = {
    ...
    "historical_memory_completion": "qsase_historical_memory_completion.json",
    "market_confirmation": "qsase_market_confirmation.json",
    "akber_input_completeness": "qsase_akber_input_completeness.json",
    "git_deploy_readiness": "qadam_git_deploy_readiness.json",
    "validated_edge_graduation_v2": "qsase_validated_edge_graduation.json",
    "pattern_search_v2": "qsase_full_universe_pattern_search_v2.json",
    "strategy_foundry_v2": "qsase_strategy_foundry_v2.json",
    "akber_filter_v2": "qsase_akber_filter_v2.json",
    "shadow_simulator_v2": "qsase_shadow_simulator_v2.json",
    "strategy_router_v2": "qsase_strategy_router_v2.json",
    "paperops_handoff_v2": "qsase_paperops_handoff_v2.json",
    "paper_lifecycle_v2": "qsase_paper_lifecycle_v2.json",
    "proof_ledger_v2": "qsase_proof_ledger_v2.json",
    "learning_attribution_v2": "qsase_learning_attribution_v2.json",
    "dashboard_completion_v2": "qsase_dashboard_completion_v2.json",
    ...
    "self_healing": "qadam_self_healing_state.json",
    "operational_perfection": "qadam_operational_perfection_certification.json",
    "operational_soak": "qadam_operational_soak_run.json",
    "final_live_declaration": "qadam_final_live_declaration.json",
    ...
    "layered_market_judgment": "qadam_layered_market_judgment_dashboard.json",
}
...
def build_cockpit_status(settings: Settings | None = None) -> dict[str, Any]:
    ...
    payload = {
        ...
        "layered_market_judgment": _read_public_runtime_artifact(
            Path(settings.runtime_dir)
    ...
    payload["promotion_gates"] = build_promotion_gates(
