...
- Deploy via `landing-page-repo/scripts/deploy-vercel-production.sh` with the CC0 rollback ready; the asset version query has advanced through the Mission Control walkthrough overhaul to `20260629-qsase-dashboard` after the QSASE public dashboard was wired into the portfolio-first runtime view.
