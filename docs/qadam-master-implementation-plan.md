...
2. Require `scripts/check_postgres_timescale_ingestion.py --require-live`, `scripts/check_postgres_timescale_replay.py --require-full-source-coverage`, and `scripts/check_phase2_durable_replay_cycle.py` to remain green before deepening intelligence workflows.
