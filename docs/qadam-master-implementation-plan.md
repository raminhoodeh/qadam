...
2. Require `scripts/check_postgres_timescale_ingestion.py --require-live` and `scripts/check_postgres_timescale_replay.py --require-full-source-coverage` to remain green before deepening intelligence workflows.
